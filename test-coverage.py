# from https://github.com/platformio/platformio-core/issues/882#issuecomment-816256339
import os
...
def generateCoverageInfo(source, target, env):
    ...
    os.system(
        "lcov --remove lcov.info '*/tool-unity/*' '*/test/*' '*/MockArduino/*' -o filtered_lcov.info")
